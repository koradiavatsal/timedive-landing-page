        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="card-feature">
              ...
              <p className="mb-6 flex-grow">{feature.description}</p>
              <a 
                href={feature.link} 
                className="flex items-center text-timedive-primary font-medium hover:text-timedive-accent transition-colors"
              >
